...
Event = new SimpleSchema({
		  ...
		  createdat:   {type: Date,      label: "Created At" ,  optional: true},
		  createdby:   {type: String,    label: "Created By",   optional: true},//Meteor.userId},
		  updatedat:   {type: Date,      label: "Updated At",   optional: true},
		  updatedby:   {type: String,    label: "Updated By",   optional: true}// Meteor.userId}
});
